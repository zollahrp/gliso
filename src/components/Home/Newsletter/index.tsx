                ...
                <div className="bg-primary rounded-Newsletter grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    <div className="col-span-7">
                        <div className="m-10 lg:ml-32 lg:mt-20 lg:mb-20">
                            <p className="text-lg font-normal text-white mb-3 ls-51"> Tetap Terhubung! </p>
                            <h2 className="text-3xl md:text-5xl font-semibold text-white mb-8">
                                Dapatkan info terbaru & promo menarik langsung ke emailmu.
                            </h2>
                    ...
                    <div className="col-span-5 relative hidden md:block">
                        <div>
                            <Image src={'/images/Newsletter/cucian.svg'} alt="cucian-image" width={626} height={602} className='-mt-24' />
                        </div>
                        <div className="absolute top-[78%]">
                            <Image src={'/images/Newsletter/daun.svg'} alt="daun-image" width={300} height={122} />
                        </div>
                        <div className="absolute top-[30%] right-[-23%] hidden lg:block">
                            <Image src={'/images/Newsletter/kilauan.svg'} alt="kilauan-image" width={300} height={122} />
                        </div>
